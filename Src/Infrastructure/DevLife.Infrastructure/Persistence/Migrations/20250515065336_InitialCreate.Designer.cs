...
namespace DevLife.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250515065336_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevLife.Domain.Modules.Contracts.Entity.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevLife.Domain.Modules.Materials.Entity.Material", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevLife.Domain.Modules.Materials.MaterialType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DevLife.Domain.Commons.Entity.CompanyContractEmployee", b =>
                {
                    ...
                    b.HasOne("DevLife.Domain.Modules.Contracts.Entity.Contract", "Contract")
                        .WithMany("CompanyContractEmployees")
            ...
            modelBuilder.Entity("DevLife.Domain.Commons.Entity.CompanyMaterialEmployee", b =>
                {
                    ...
                    b.HasOne("DevLife.Domain.Modules.Materials.Entity.Material", "Material")
                        .WithMany("CompanyMaterialEmployees")
            ...
            modelBuilder.Entity("DevLife.Domain.Modules.Materials.Entity.Material", b =>
                {
                    b.HasOne("DevLife.Domain.Modules.Materials.MaterialType", "MaterialType")
                        .WithMany()
